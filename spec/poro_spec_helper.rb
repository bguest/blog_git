...
def mock_post_response
  JSON.generate({
    "name"=> "my_blog.markdown",
    "path"=> "my_blog.markdown",
    "sha"=> "1234567891234567891234567891234567891234",
    "size"=> 530,
    "url"=> "https://api.github.com/repos/bguest/blog/contents/my_post.markdown?ref=master",
    "html_url"=> "https://github.com/bguest/blog/blob/master/my_post.markdown",
    "git_url"=> "https://api.github.com/repos/bguest/blog/git/blobs/1234567891234567891234567891234567891234",
    "download_url"=> "https://raw.githubusercontent.com/bguest/blog/master/my_post.markdown",
    "type"=> "file",
...
def mock_blog_response
  JSON.generate(
    [
      ...
      {
        "name" => "my_post.markdown",
        "path" => "my_post.markdown",
        "sha" => "1234567891234567891234567891234567891234",
        "size" => 645,
        "url" => "https://api.github.com/repos/bguest/blog/contents/my_post.markdown?ref=master",
        "html_url" => "https://github.com/bguest/blog/blob/master/my_post.markdown",
        ...
        "type" => "file",
        "_links" => {
          "self" => "https://api.github.com/repos/bguest/blog/contents/my_post.markdown?ref=master",
          "git" => "https://api.github.com/repos/bguest/blog/git/blobs/1234567891234567891234567891234567891234",
          "html" => "https://github.com/bguest/blog/blob/master/my_post.markdown"
        }
      }
    ]
  )
